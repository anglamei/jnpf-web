...
export default class BgcolorTool extends Tool{
    ...
    buildButton(){
        ...
        this.nameButton=$(`<button type="button" class="btn btn-default"
            style="border:none;border-radius:0;padding: 2px 1px 6px 5px;" title="${window.i18n.tools.bgColor.bgColor}">
                <span class="report-icon report-icon-background-color"></span>
                <span class="ud-select-bgcolor"></span>
            </button>`);
        group.append(this.nameButton);
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.bgColor.bgColor}">
