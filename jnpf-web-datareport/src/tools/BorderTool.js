...
export default class BorderTool extends Tool{
    ...
    buildButton(){
        ...
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.border.borderLine}">
            <i class="report-icon report-icon-border-none"></i>
            <span class="caret"></span>
        </button>`);
        const ul=$(`<ul class="dropdown-menu" role="menu"></ul>`);
        const fullBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-all" style="color: #0e90d2;"></i> ${window.i18n.tools.border.allLine}
                </a>
            </li>`);
        ...
        const noBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-none"></i> ${window.i18n.tools.border.noBorder}
                </a>
            </li>`);
        ...
        const leftBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-left"></i> ${window.i18n.tools.border.leftBorder}
                </a>
            </li>`);
        ...
        const rightBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-right"></i> ${window.i18n.tools.border.rightBorder}
                </a>
            </li>`);
        ...
        const topBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-top"></i> ${window.i18n.tools.border.topBorder}
                </a>
            </li>`);
        ...
        const bottomBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-bottom"></i> ${window.i18n.tools.border.bottomBorder}
                </a>
            </li>`);
        ...
        const customBorder=$(`<li>
                <a href="javascript:;">
                    <i class="report-icon report-icon-border-custom"></i> ${window.i18n.tools.border.customBorder}
                </a>
            </li>`);
        let content=null;
