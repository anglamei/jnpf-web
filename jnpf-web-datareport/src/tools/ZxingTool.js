...
export default class ZxingTool extends Tool{
    ...
    buildButton(){
        ...
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" style="border:none;border-radius:0;padding: 6px 5px;" data-toggle="dropdown" title="${window.i18n.tools.zxing.title}">
