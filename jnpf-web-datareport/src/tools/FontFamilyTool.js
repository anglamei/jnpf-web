...
export default class FontFamilyTool extends Tool{
    ...
    buildButton(){
        ...
        this.nameButton=$(`<button type="button" class="btn btn-default"
            style="border:none;border-radius:0;padding: 6px 1px 6px 5px;" title="${window.i18n.tools.font.font}">
            <i class="report-icon report-icon-font"></i>
        </button>`);
        group.append(this.nameButton);
        const mainBtn=$(`<button type="button" class="btn btn-default dropdown-toggle" data-toggle="dropdown" style="border:none;border-radius:0;padding: 6px 5px;" title="${window.i18n.tools.font.font}">
        ...
        for(let font of fonts){
            let family=$(`<li data="${font}"><a href='javascript:;'>${font}</a></li>`);
            ul.append(family);
