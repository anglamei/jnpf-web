...
export default class ImageValueEditor extends BaseValueEditor {
    ...
    _initSizeGroup() {
        const _this = this;
        const widthGroup = $(`<div class="custom-formitm el-input--small"><label class="lab">宽：</label></div>`);
        this.widthEditor = $(`<input class="form-control ipt el-input__inner" type="number" placeholder="为0或空表示采用图片默认宽度" style="display: inline-block;width:278px;padding-right: 3px">`);
        ...
        const heightGroup = $(`<div class="custom-formitm el-input--small"><label class="lab">高：</label></div>`);
        this.heightEditor = $(`<input class="form-control ipt el-input__inner" type="number" placeholder="为0或空表示采用图片默认高度" style="display: inline-block;width:278px;padding-right: 3px">`);
    ...
    _initTypeSelect() {
        const imageSourceGroup = $(`<div class="custom-formitm "><label class="lab">${window.i18n.property.image.source}</label></div>`);
    ...
    _initPathEditor() {
        const _this = this;
        this.pathEditorGroup = $(`<div class="custom-formitm el-input--small"><label class="lab">${window.i18n.property.image.p}</label></div>`);
        this.pathEditor = $(`<input class="form-control ipt el-input__inner" title="${window.i18n.property.image.tip}" placeholder="${window.i18n.property.image.tip}" style="display: inline-block;width: 278px;padding: 5px">`);
    ...
    _initExpressionEditor() {
        this.expressionEditorGroup = $(`<div class="custom-formitm"><label class="lab">${window.i18n.property.image.exprlab}</label><div class="ipt">&nbsp;</div></div>`);
    ...
    _buildExpand() {
        const _this = this;
        this.expandGroup = $(`<div class="custom-formitm"><label class="lab">${window.i18n.property.image.expand}</label></div>`);
