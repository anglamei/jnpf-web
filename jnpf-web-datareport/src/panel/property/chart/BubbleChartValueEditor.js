...
export default class ScatterChartValueEditor extends CategoryChartValueEditor {
    ...
    _initDatasetTab(dsContent) {
        ...
        const datasetGroup = $(`<div class="form-group custom-formitm-l"><label class="lab">${window.i18n.chart.dataset}</label></div>`);
        legendGroup.append(datasetGroup);
        this.datasetSelect = $(`<select class="form-control ipt" style="display: inline-block;width:220px;padding:2px;font-size: 12px;height: 32px"></select>`);
        datasetGroup.append(this.datasetSelect);

        const categoryPropertyGroup = $(`<div class="form-group custom-formitm-l" style="margin-top:10px"><label class="lab">${window.i18n.chart.categoryProperty}</label></div>`);
        this.categoryPropertySelect = $(`<select class="form-control ipt" style="display: inline-block;width:220px;padding: 2px;font-size: 12px;height: 32px"></select>`);
        ...
        const xPropertyGroup = $(`<div class="form-group custom-formitm-l"><label class="lab">${window.i18n.chart.xProperty}</label></div>`);
        this.xPropertySelect = $(`<select class="form-control ipt" style="display: inline-block;width:220px;padding: 2px;font-size: 12px;height: 32px"></select>`);
        ...
        const yPropertyGroup = $(`<div class="form-group custom-formitm-l"><label class="lab">${window.i18n.chart.yProperty}</label></div>`);
        this.yPropertySelect = $(`<select class="form-control ipt" style="display: inline-block;width:220px;padding: 2px;font-size: 12px;height: 32px"></select>`);
        ...
        const rPropertyGroup = $(`<div class="form-group custom-formitm-l"><label class="lab">${window.i18n.chart.rProperty}</label></div>`);
        this.rPropertySelect = $(`<select class="form-control ipt" style="display: inline-block;width: 220px;padding: 2px;font-size: 12px;height: 32px"></select>`);
