...
export default class BuildinTree extends BaseTree {
    ...
    _buildDatasource() {
        ...
        const rootSpan = $(`
            <span id="${this.id}">
                ...
                <i class="ureport ureport-shareconnection"></i> <a href='javascript:;' class="ds_name">${this.name}</a>
            </span>`);
    ...
    addDataset(dataset) {
        ...
        const span = $(`<span id="${spanId}"><i class='ureport ureport-minus' style='margin-right:2px'></i> <i class="ureport ureport-sqlds"></i> <a href='javascript:;' class="dataset_name">${dataset.name}</a></span>`);
        li.append(span);
    ...
    addField(dataset, fields, field, ul) {
        ...
        const li = $(`<li></li>`);
        const spanId = uuid.v1();
        const span = $(`<span id="${spanId}" title="${window.i18n.tree.doubleClick}"><i class="ureport ureport-property"></i> <a href='javascript:;'>${field.name}</a></span>`);
        li.append(span);
